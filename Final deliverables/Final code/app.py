...
dsn_uid = 'jhj79826'
dsn_pwd = 'QGM66Sy9CTlMsFC1'
dsn_driver = "{IBM DB2 ODBC DRIVER}"
dsn_database = "bludb"
dsn_port = '31198'
dsn_security = "SSL"
dsn_certificate = 'DigiCertGlobalRootCA.crt'
...
dsn = (
    ...
    "UID={5};"
    "PWD={6};"
).format(dsn_database, dsn_hostname, dsn_port, dsn_security,dsn_certificate, dsn_uid, dsn_pwd)
...
app.config['uid'] = 'jhj79826'
app.config['pwd'] = 'QGM66Sy9CTlMsFC1'
app.config['security'] = 'SSL'
try:
    mysql = DB2(app)

    # conn_str='''database=bludb;hostname=0c77d6f2-5da9-48a9-81f8-86b520b87518.bs2io90l08kqb1od8lcg.databases.appdomain.cloud;port=31198;
    #         uid=jhj79826;pwd=QGM66Sy9CTlMsFC1;security=SSL'''
